...
`npm run typecheck` · `npm test`(12) · `npm run e2e`(기능 10 + UI·반응형 8: 320/390/768/1024/1440/1920px, PC 정렬선, 목록·STAR·설정 구조) · `npm run e2e:static` · CI `.github/workflows/ci.yml`
